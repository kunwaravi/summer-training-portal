      ...
      {loading ? (
        ...
        <div className="bg-slate-900/30 border border-slate-900/60 rounded-2xl overflow-hidden shadow-sm">
          <Table className="border-collapse">
            <TableHeader>
              <TableRow className="border-b border-slate-900 text-[11px] text-slate-500 font-black uppercase tracking-wider bg-slate-950/20">
                <TableHead className="py-4 px-6 text-center w-20">Rank</TableHead>
                <TableHead className="py-4 px-4">Student Details</TableHead>
                <TableHead className="py-4 px-4 hidden md:table-cell">College</TableHead>
                <TableHead className="py-4 px-4">Achievements</TableHead>
                <TableHead className="py-4 px-6 text-right w-32">Total Score</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody className="divide-y divide-slate-900/50">
                {users.map((item, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* College */}
                      <TableCell className="py-4 px-4 hidden md:table-cell text-xs text-slate-400">
