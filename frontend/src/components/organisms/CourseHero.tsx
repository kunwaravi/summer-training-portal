...
const CourseHero: React.FC<CourseHeroProps> = ({
  ...
  return (
    <div className="space-y-3.5 border-b border-slate-850 pb-4">
      ...
      <nav className="flex items-center gap-1.5 text-[11px] sm:text-[11px] font-black uppercase tracking-wider text-slate-500">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[11px] uppercase tracking-widest text-slate-400 font-black bg-slate-900/60 px-3 py-1 rounded-full border border-slate-850 shadow-inner">
            {courseId} Track
          </span>
        </div>
      </div>
