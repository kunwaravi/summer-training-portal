...
import { Mail, Lock, LogIn, ArrowRight, Zap, CheckCircle } from 'lucide-react';
...
const LoginPage = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    setIsLoading(true);
    try {
      // Simulate Google OAuth flow by directly requesting Google login API on backend
      const mockGoogleUser = {
        email: email || 'student.edunexus@gmail.com',
        name: email ? email.split('@')[0] : 'Edu Student',
      };
